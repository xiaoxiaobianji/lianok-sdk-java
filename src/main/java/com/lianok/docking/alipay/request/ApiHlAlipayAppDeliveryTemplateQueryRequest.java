...
import com.lianok.docking.alipay.response.ApiHlAlipayAppDeliveryTemplateQueryResponse;

import java.util.List;


public class ApiHlAlipayAppDeliveryTemplateQueryRequest extends AbstractDockingRequest {
    /**
     * 商户号
     */
