...
import com.lianok.docking.alipay.entity.CertificateUseInfo;
import com.lianok.docking.alipay.response.ApiHlAlipayCertUseResponse;

import java.util.Date;
import java.util.List;


public class ApiHlAlipayCertUseRequest  extends AbstractDockingRequest {
    /**
     * 商户号
     */
