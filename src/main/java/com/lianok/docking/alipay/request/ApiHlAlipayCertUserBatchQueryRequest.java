...
import com.lianok.docking.alipay.response.ApiHlAlipayCertUserBatchQueryResponse;


public class ApiHlAlipayCertUserBatchQueryRequest  extends AbstractDockingRequest {
    /**
     * 商户号
     */
