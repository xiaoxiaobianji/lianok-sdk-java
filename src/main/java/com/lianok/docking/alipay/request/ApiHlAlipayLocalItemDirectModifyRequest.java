...
import com.lianok.docking.alipay.response.ApiHlAlipayLocalItemDirectModifyResponse;

import java.util.List;


public class ApiHlAlipayLocalItemDirectModifyRequest extends AbstractDockingRequest {
    /**
     * 商户号
     */
    ...
    public Class<? extends DockingResponseBase> getResponseClass() {
        return ApiHlAlipayLocalItemDirectModifyResponse.class;
    }
}
