...
import com.lianok.docking.alipay.response.ApiHlAlipayLocalItemListQueryResponse;

import java.util.List;


public class ApiHlAlipayLocalItemListQueryRequest extends AbstractDockingRequest {
