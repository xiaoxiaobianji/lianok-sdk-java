...
import com.lianok.docking.alipay.response.ApiHlAlipayMiniOrderDeliverySendResponse;

import java.time.LocalDateTime;
import java.util.List;


public class ApiHlAlipayMiniOrderDeliverySendRequest extends AbstractDockingRequest {
    /**
     * 商户号
     */
