...
import com.lianok.docking.merchant.response.ApiHlShopUpdateQualificationInfoResponse;
 ...
 * 修改资质信息
 */
public class ApiHlShopUpdateQualificationInfoRequest extends AbstractDockingRequest {
